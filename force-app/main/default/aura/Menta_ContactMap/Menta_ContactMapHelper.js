({
	...
	retrieveMapCoordinate : function(objComponent) {
        ...
        if(objContact !== undefined && objContact !== null && objContact.contact !== undefined && objContact.contact !== null) {
            objCoordinate = {};
            objCoordinate.Latitude = objContact.contact.MailingLatitude;
            objCoordinate.Longitude = objContact.contact.MailingLongitude;
            objCoordinate.Address = [];
            objCoordinate.Address[0] = objContact.contact.MailingStreet + ' ' + objContact.contact.MailingNumber__c;
            objCoordinate.Address[1] = objContact.contact.Level4Name__c;
            objCoordinate.Address[2] = objContact.contact.Level3Name__c;
            objCoordinate.Address[3] = objContact.contact.Level2Name__c;
            objCoordinate.Address[4] = objContact.contact.Level1Name__c;
            ...
            objCoordinate.Google.center.lng = objCoordinate.Longitude + 0.0017;
        }
