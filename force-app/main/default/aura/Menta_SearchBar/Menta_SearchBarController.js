({        
    ...
    searchText : function(objComponent, objEvent, objHelper) {
        ...
        if (objEvent.keyCode === 13) {
            ...
            if(strSearchText !== undefined && strSearchText !== null && strSearchText.length > 3) {
    ...
    onFocus : function (objComponent, objEvent, objHelper) {
        ...
        document.getElementById('search-super-d').classList.add('search-focus');
        var searchInput = objComponent.find('enter-search').getElement();
        objHelper.placeholder = objComponent.find('enter-search').getElement().placeholder;
        console.log('prueba: ' + objHelper.placeholder);
    ...
    onBlur : function (objComponent, objEvent, objHelper) {
        ...
        document.getElementById('search-super-d').classList.remove('search-focus');
        var searchInput = objComponent.find('enter-search').getElement();
        searchInput.placeholder = objHelper.placeholder;
