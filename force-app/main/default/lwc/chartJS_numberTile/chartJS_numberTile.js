...
export default class ChartJS_numberTile extends LightningElement {
    ...
    //no le pude cambiar el nombre la variable. Primero no funcionaba nada, despues en una prueba aislada, me dejo ponerle "sarasa".
    //y ahora, al querer renombrarlo correctamnete, no se puede cambiar. Aguante SALESFORCE VIEJAAAAA
    ...
    @api set results(value) {
        //console.log('tile component setResults:', JSON.stringify(value));
        this._results = value;
        this.queryValue = value[0] ? value[0].count : 0;
    }
    get results() {
    ...
    set selection(selection) {
        //console.log('Set selection as variable: ', JSON.stringify(selection));
