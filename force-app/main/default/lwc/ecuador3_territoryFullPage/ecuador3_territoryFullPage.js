...
export default class Newcom_territoryFullPage extends LightningElement {
    ...
    wiredTerritory({ error, data }) {
        ...
        console.log('total:', this.territoryInfo.total)
        console.log('men:', this.territoryInfo.totalmen)
        console.log('women:', this.territoryInfo.totalwomen)
        if (this.territoryInfo.total) {
            let temptw = parseInt(this.territoryInfo.totalwomen.replace('.',''),10);
            let temptm = parseInt(this.territoryInfo.totalmen.replace('.',''),10);
            let tempt = parseInt(this.territoryInfo.total.replace('.',''),10);
