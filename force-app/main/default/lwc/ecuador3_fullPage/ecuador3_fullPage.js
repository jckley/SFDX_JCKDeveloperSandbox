...
export default class Newcom_fullPage extends NavigationMixin(LightningElement) {
    ...
    wiredContact({ error, data }) {
        ...
        if (data) {
            ...
            let provincia = (this.record.citizen.ec_electoral_provincia_name__c ? this.record.citizen.ec_electoral_provincia_name__c : " ");
            let canton  = (this.record.citizen.ec_electoral_canton_name__c ? this.record.citizen.ec_electoral_canton_name__c : " ");
            let parroquia = (this.record.citizen.ec_electoral_parroquia_name__c ? this.record.citizen.ec_electoral_parroquia_name__c : " ");
            let recinto = (this.record.citizen.ec_electoral_recinto_name__c ? this.record.citizen.ec_electoral_recinto_name__c : " ")

            this.electoral_array.push({"title": "Provincia Votación:", "value": provincia});
            this.electoral_array.push({"title": "Cantón Votación:"           , "value": canton});
            this.electoral_array.push({"title": "Parroquia Votación:"           , "value": parroquia});
            this.electoral_array.push({"title": "Recinto\rVotación:"              , "value": recinto});
            ...
            console.log('affiliation:', this.record.citizen.ec_party_affiliation__c);
            if(this.record.citizen.ec_party_affiliation__c !== null && this.record.citizen.ec_party_affiliation__c!==undefined && this.record.citizen.ec_party_affiliation__c!==''){
                this.noParty = false;
    ...
    renderMap(scenario) {
        ...
        if(this.record !== undefined && this.record !== null && this.record.citizen !== undefined && this.record.citizen !== null) {
            ...
            arrAddress.push('Ecuador');
            arrAddress2.push("country=Ecuador");
        }
