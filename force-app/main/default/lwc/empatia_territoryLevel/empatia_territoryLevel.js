...
export default class Empatia_territoryLevel extends NavigationMixin(LightningElement) {
    @wire(CurrentPageReference) pageRef;
    iconSearch = Resources + '/SALESFORCE/img/Territories/iconsearch.svg';
    iconClose = Resources + '/SALESFORCE/img/Territories/closetab.svg';
    iconRight = Resources + '/SALESFORCE/img/Territories/arrowrightps.svg';
    iconArrow = Resources + '/SALESFORCE/img/Territories/arrowps.svg';
    iconNivelAdm = Resources + '/SALESFORCE/img/Territories/niveladminsitrativops.svg';
