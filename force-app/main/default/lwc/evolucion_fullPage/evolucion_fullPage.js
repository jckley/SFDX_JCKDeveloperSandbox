    ...
    wiredContact({ error, data }) {
        ...
        if (data) {
            ...
            for (let mobility in this.record.movilidadInfo.movilidades) {
                this.renderMobilityInfo = false; // me pidieron que no lo muestre
            ...
            this.votos_array.push({"text": "Voto 2021 General"  , "sino": this.record.citizen.voting_G2021__c === 'EMITIDO' ? this.label.Yes : this.label.No});
            ...
            if (this.record.incomeInfo.employers !== undefined && this.record.incomeInfo.employers !== null && this.record.incomeInfo.employers.length > 0) {
                this.renderIncomeInfo = false; // me pidieron que no lo muestre
                let sum_of_income = 0;
