...
import retrieveInfoFromCitizenId from '@salesforce/apex/CommunitiesChileController.retrieveInfoFromCitizenId';
...
export default class Newcom_fullPage extends LightningElement {
    ...
    wiredContact({ error, data }) {
        ...
        if (data) {
            ...
            this.electoral_array.push({"title": "Comuna:", "value": seccion});
            this.electoral_array.push({"title": "Circunscripción Electoral:", "value": circuito});
