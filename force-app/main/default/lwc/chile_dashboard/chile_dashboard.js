...
import retrieveSite from '@salesforce/apex/CommunitiesChileController.retrieveSite';
import getRootTerritory from '@salesforce/apex/CommunitiesChileController.getRootTerritory';
...
export default class Newcom_dashboard extends LightningElement {
    ...
    wiredSite({ error, data }) {
        if (data) {
            ...
            this.facebookIcon = RESOURCES + '/img/facebook-b3b3b3.svg';
            this.instagramIcon = RESOURCES + '/img/instagram-b3b3b3.svg';
            this.twitterIcon = RESOURCES + '/img/twitter-b3b3b3.svg';
            this.linkedinIcon = RESOURCES + '/img/linkedin-b3b3b3.svg';
